...
<input type="radio" name="clientpronoun" value="Mr"	 <?php echo $myclient->fields['clientpronoun']=='Mr' ? 'checked':'' 	?> > Mr&nbsp;&nbsp;&nbsp;
...
<td class="td2" colspan=4>
	...
	<?php echo $myclient->displayInputBox('clientfirstname',1); ?>
	<?php echo $myclient->displayInputBox('clientlastname',1); ?>
	<?php echo $myclient->displayInputBox('clientinitial',1); ?>
...
<input type="radio" name="clientcopronoun" value="Mr"	 <?php echo $myclient->fields['clientcopronoun']=='Mr' ? 'checked':'' 	?> > Mr&nbsp;&nbsp;&nbsp;
<input type="radio" name="clientcopronoun" value="Mrs"	 <?php echo $myclient->fields['clientcopronoun']=='Mrs' ? 'checked':'' 	?> > Mrs&nbsp;&nbsp;&nbsp;
<input type="radio" name="clientcopronoun" value="Miss"	 <?php echo $myclient->fields['clientcopronoun']=='Miss' ? 'checked':'' 	?> > Miss&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="clientcopronoun" value="Dr"	 <?php echo $myclient->fields['clientcopronoun']=='Dr' ? 'checked':'' 	?> > Dr&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="clientcopronoun" value=""	 <?php echo $myclient->fields['clientcopronoun']=='' ? 'checked':'' 	?> > Other
</td>
</tr>
