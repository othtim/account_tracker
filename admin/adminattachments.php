...
<form id="viewattachment" name="viewattachment" action="adminattachments.php" method="post">
...
if( isset($_POST['add']) ){
	...
	echo "<form action=\"adminattachments.php\" enctype=\"multipart/form-data\" method=\"post\">
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//only show the details if a component has been selected
//
if( isset($pdata['blobid']) ){
	...
	<form action="adminattachments.php" method="post">
...
echo "<form name=\"addform\" action=\"adminattachments.php\" method=\"post\">
<input type=\"hidden\" name=\"add\" value=\"add\">
<input type=\"hidden\" name=\"clientid\" value=\"".$clientid."\">
